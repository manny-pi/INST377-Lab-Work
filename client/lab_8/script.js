...
function injectHTML(list) {
  ...
  target.innerHTML = ''; // Clear whatever HTML is already in target
...
async function mainEvent() {
  ...
  if (arrayFromJson.data?.length > 0) {
    ...
    loadAnimation.classList.add('lds-ellipsis_hidden'); // let's turn the submit button back on by setting it to display as a block when we data available
